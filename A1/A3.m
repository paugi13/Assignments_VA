...
for j = 1:10
    i = 1:6:ndof;
    modesMeta_UC(:, 1,j) = MODES_UC(i,j);
    i = 2:6:ndof;
    modesMeta_UC(:, 2,j) = MODES_UC(i,j);
    i = 3:6:ndof;
    modesMeta_UC(:, 3,j) = MODES_UC(i,j);
    i = 4:6:ndof;
    modesMeta_UC(:, 4,j) = MODES_UC(i,j);
    i = 5:6:ndof;
    modesMeta_UC(:, 5,j) = MODES_UC(i,j);
    i = 6:6:ndof;
    modesMeta_UC(:, 6,j) = MODES_UC(i,j);
end
fillhdf('template.h5','A3_1_2.h5',modesMeta_UC(:,:,1));
fillhdf('template.h5','A3_2_2.h5',modesMeta_UC(:,:,2));
fillhdf('template.h5','A3_3_2.h5',modesMeta_UC(:,:,3));
fillhdf('template.h5','A3_4_2.h5',modesMeta_UC(:,:,4));
fillhdf('template.h5','A3_5_2.h5',modesMeta_UC(:,:,5));
fillhdf('template.h5','A3_6_2.h5',modesMeta_UC(:,:,6));
fillhdf('template.h5','A3_7_2.h5',modesMeta_UC(:,:,7));
fillhdf('template.h5','A3_8_2.h5',modesMeta_UC(:,:,8));
fillhdf('template.h5','A3_9_2.h5',modesMeta_UC(:,:,9));
fillhdf('template.h5','A3_10_2.h5',modesMeta_UC(:,:,10));